...
#include "sqp_2_mass_spring_damper_demo_sqp_cost_matrices.hpp"
...
int main(void) {
  ...
  // First, you must run "sqp_2_mass_spring_damper_demo.py" to generate the cost
  // matrices C++ code.
  auto cost_matrices = sqp_2_mass_spring_damper_demo_sqp_cost_matrices::make();

  using X_Type = sqp_2_mass_spring_damper_demo_sqp_cost_matrices::X_Type;

  constexpr std::size_t STATE_SIZE =
      sqp_2_mass_spring_damper_demo_sqp_cost_matrices::STATE_SIZE;
  constexpr std::size_t INPUT_SIZE =
      sqp_2_mass_spring_damper_demo_sqp_cost_matrices::INPUT_SIZE;
  constexpr std::size_t NP =
      sqp_2_mass_spring_damper_demo_sqp_cost_matrices::NP;

  using Reference_Trajectory_Type =
      sqp_2_mass_spring_damper_demo_sqp_cost_matrices::
          Reference_Trajectory_Type;

  using Cost_Matrices_Type =
      sqp_2_mass_spring_damper_demo_sqp_cost_matrices::type;
  ...
  auto X_initial = make_DenseMatrix<STATE_SIZE, 1>(
      static_cast<double>(5), static_cast<double>(0), static_cast<double>(5),
